# Feedback Generator — User Guide

A collection of tools for university academics at Northumbria University to generate
personalised student feedback sheets, cohort analytics reports, and marking resources.
...
**No student data is stored.** All uploaded spreadsheet data is held in your browser session
only and is discarded once you close the tab or the session expires. Nothing is written to a
database.
