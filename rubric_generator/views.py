...
def home(request):
    ...
    return render(request, "rubric_generator/home.html", {
        "page_title": "Feedback",
        "templates": templates
    })
...
def template_edit(request, pk):
    ...
    return render(request, "rubric_generator/template_edit.html", {
        "template": tpl,
...
def template_rubric(request, pk):
    ...
    return render(request, "rubric_generator/template_rubric.html", {
        "template": tpl,
...
def template_feedback_sheet(request, pk):
    ...
    try:
        from rubric_generator.utils import grade_for_percentage
    ...
    return render(request, "rubric_generator/template_feedback_sheet.html", {
        "template": tpl,
        "categories_with_bands": categories_with_bands,
